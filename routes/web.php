...
Route::get('/homepage', [MyController::class, 'homepage'])->name('homepage')->middleware('guest');

Route::get('/about',[MyController::class, 'about'])->name('about');

Route::get('/upcomingExam',[MyController::class, 'upcomingExam'])->name('upcomingExam');
Route::get('/ongoingExam',[MyController::class, 'ongoingExam'])->name('ongoingExam');
Route::get('/previousExam',[MyController::class, 'previousExam'])->name('previousExam');

Route::get('/noticeBoard',[MyController::class, 'noticeBoard'])->name('noticeBoard');

Route::get('/viaEmail',[MyController::class, 'viaEmail'])->name('viaEmail');
Route::get('/viaMessenger',[MyController::class, 'viaMessenger'])->name('viaMessenger');
Route::get('/viaPhone',[MyController::class, 'viaPhone'])->name('viaPhone');
...
Route::get('/notice-home',[MyController::class, 'noticeHome'])->name('noticeHome');
Route::get('/ongoing-exam',[MyController::class, 'ongoingHome'])->name('ongoingHome');
Route::get('/upcoming-exam',[MyController::class, 'upcomingHome'])->name('upcomingHome');
Route::get('/previous-exam',[MyController::class, 'previousHome'])->name('previousHome');
...
// //     \Auth::guard('assesse')->attempt($crs);
// //     if(  \Auth::guard('assesse')->check()){
// //       return  redirect('/studentDash');
// //     }
// //   } else {
// //     $crs = $request->only(['email', 'password']);
// //     \Auth::guard('assessor')->attempt($crs);
